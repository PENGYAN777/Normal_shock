...
fig1.savefig("files/d4_similar_gp.eps")
...
# axes.set_title('$T_2/T_1$ under conditions sharing same $\Gamma_1$ with different $P_1,T_1$')
# fig2.savefig("files/mm_similar_gt.eps")
...
fig3.savefig("files/d4_similar_gm.eps")
