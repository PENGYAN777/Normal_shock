...
plot 
"""
nn = 7 # number of columes in data.csv
...
#     lb = '$P_1/P_c=$' + str(float("{:.2f}".format(P1_list[k]/Pc)))  
...
# fig1.savefig("files/nicfd_p_d4_rp.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig2.savefig("files/nicfd_p_d4_rt.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig3.savefig("files/nicfd_p_d4_rd.eps")
...
# axes.legend(loc=9 , prop={'size': 10}) # 
# axes.set_title('$M_2/M_1$ vs $Z_1$',fontsize=14)
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig4.savefig("files/nicfd_p_d4_rm.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig5.savefig("files/nicfd_p_d4_rpt.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig6.savefig("files/nicfd_p_d4_ry.eps")
