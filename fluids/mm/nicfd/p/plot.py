...
# fig1.savefig("files/nicfd_p_mm_rp.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig2.savefig("files/nicfd_p_mm_rt.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig3.savefig("files/nicfd_p_mm_rd.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig4.savefig("files/nicfd_p_mm_rm.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig5.savefig("files/nicfd_p_mm_rpt.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig6.savefig("files/nicfd_p_mm_ry.eps")
