...
read csv file
"""
T1_list = np.arange(620, 660, 10).tolist()
nc = len(T1_list)
...
plot 
"""
nn = 8 # number of columes in data.csv
...
# fig1.savefig("files/nicfd_t_d6_rp.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig2.savefig("files/nicfd_t_d6_rt.eps")
...
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# fig3.savefig("files/nicfd_t_d6_rd.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig4.savefig("files/nicfd_t_d6_rm.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig5.savefig("files/nicfd_t_d6_rpt.eps")
...
axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
fig6.savefig("files/nicfd_t_d6_ry.eps")
...
# axes.legend(loc=0 , prop={'size': 10}) # 
# axes.set_title('$(h_{t2}-h_{t1})/h_{t1}(\%)$ vs $Z_1$',fontsize=14)
# axes.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
# axes.set_ylim([0, 0.1])
